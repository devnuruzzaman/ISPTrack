    ...
    <div class="card">
        <div class="card-header bg-purple text-white">
            <h3 class="card-title mb-0">
                <img src="{{ asset('images/rocket.png') }}" alt="Rocket Logo" style="height:24px;width:auto;margin-right:8px;">
                Rocket Gateway Settings
            </h3>
        </div>
        <div class="card-body">
            @if(session('success'))
            ...
            @endif
            <form action="{{ route('admin.billings.rocket.update') }}" method="POST">
                @csrf
